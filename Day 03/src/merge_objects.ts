...
// still type safe
export function mergeObject3<T extends object , U extends object> (obj1: T, obj2: U):T&U{
    return {...obj1, ...obj2};
}
...
export function mergeObject4<T extends object, U extends object>(obj1: T, obj2: U): DeepMerge<T, U> {
...
export function mergeObject5<T extends object , U extends object>(...objs:[T,U]): T&U{
